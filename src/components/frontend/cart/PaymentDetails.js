  ...
  return (
    <div className={classes.root}>
      ...
      <div className={classes.priceDiv}>
        ...
        <span className={classes.price}>KSH {aPrice}</span>
      </div>
      <Divider className={classes.divider} />
      <div className={classes.priceDiv}>
        <label className={classes.priceHead}>Discount</label>
        <span className={classes.price}>-KSH {aPrice - tPrice} </span>
      </div>
      <Divider className={classes.divider} />
      <div className={classes.tPriceDiv}>
        <label className={classes.tPriceHead}>Total Amount</label>
        <span className={classes.tPrice}>KSH {tPrice}</span>
      </div>
      <div className={classes.save}>You Save KSH {aPrice - tPrice}</div>
    </div>
  );
}
